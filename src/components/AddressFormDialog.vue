<template>
    <div>
        ...
        >
                ...
                <form class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <md-field
                            :class="{
                                'md-invalid':
                                    $v.form.extNumber.$invalid &&
                                    $v.form.extNumber.$dirty,
                            }"
                        >
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <md-field
                            :class="{
                                'md-invalid':
                                    $v.form.reference.$invalid &&
                                    $v.form.reference.$dirty,
                            }"
                        >
            ...
            <md-dialog-actions>
                <md-button class="md-dense" @click="handleDialogClose">
                    Cancelar
                </md-button>
                <md-button
                    :disabled="
...
export default {
    ...
    watch: {
        active: function (val) {
            if (val && this.addressId) this.fetchAddress();
        },
    },
    computed: {
        showDialog: {
    ...
    methods: {
        /**
         * @description
         * The `fetchAddress` method will fetch the address data to edit.
        ...
        async onSubmit() {
            try {
                const requestFn = this.addressId ? Patch : Post;
                const requestPath = this.addressId
        ...
        handleStateChange(state) {
            ...
            this.form.city = this.patchingForm ? this.form.city : null;
