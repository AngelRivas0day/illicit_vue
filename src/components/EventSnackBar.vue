<template>
	<div v-if="isActive">
		<md-dialog :md-active.sync="show">
			...
			<md-dialog-content> Lorem ipsum dolor sit amet, consectetur adipis Lorem ipsum dolor sit amet, consectetur adipis Lorem ipsum dolor sit amet, consectetur adipis </md-dialog-content>
			<md-dialog-actions class="text-right">
				<md-button @click="show = !show" class="md-primary md-stroked md-dense"> Cerrar </md-button>
				<md-button @click="goToEvent" class="md-primary md-raised md-dense"> Ver m&aacute;s </md-button>
			</md-dialog-actions>
		</md-dialog>
	</div>
</template>
