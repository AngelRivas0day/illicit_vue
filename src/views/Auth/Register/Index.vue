    ...
    computed: {
        isRepeatedPasswordValid() {
            if (
                ...
                this.$v.form.repeatedPassword.minLength &
                    this.$v.form.repeatedPassword.required
            ) {
                return true;
            } else {
                return false;
        ...
        isPasswordValid() {
            if (
                this.$v.form.password.sameAsRepeatedPassword &&
                this.$v.form.password.minLength & this.$v.form.password.required
            ) {
                return true;
            } else {
                return false;
