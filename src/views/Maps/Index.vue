<template>
	<div v-if="pins.length != 0" class="maps">
		<div class="maps-inner">
			...
			<div class="maps__render-map" :class="[isTransition ? 'animate' : 'no-animate']">
				<gmap-map v-if="pinsLoaded" class="map" :center="currentPin.marker" :zoom="16" :options="mapStyle">
	...
	<div v-else class="maps-emtpy-state">
		<div class="empty-state-text">A&uacute;n no hay ubicaciones disponibles :(</div>
	</div>
</template>
