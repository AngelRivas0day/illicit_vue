...
export default {
	...
	async mounted() {
		...
		if (this.glass.offer) this.lenseSpecs.price = parseInt(this.glass.price) - parseInt(this.glass.offer.value)
		else this.lenseSpecs.price = parseInt(this.glass.price)
