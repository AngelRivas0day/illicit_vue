	...
	<div class="contact">
		...
		<div class="contact__form">
			<div v-if="emailSentStatus == true" class="form-success">
				<div class="row">
					<div class="col-12">
						<md-empty-state class="text-white" md-icon="mark_email_read" md-label="Mensaje envíado" md-description="Tu opinión nos importa. Te contestaremos en menos de 48 horas.">
...
.contact {
	...
	&__banner {
		flex: 1;
		background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('../../assets/img/contacto_bg.jpg');
	...
	&__form {
		...
		.form-success {
			::v-deep .md-empty-state-icon {
				color: rgba(223, 223, 223, 0.8) !important;
			}
		}
	}
	@media #{$break-medium} {
