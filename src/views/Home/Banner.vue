					...
					<div :key="slide.id" class="slide">
						<div class="slide-inner">
							<div class="slide-inner__content">
								...
								<router-link class="slide__button" :to="slide.buttonUrl">{{ slide.buttonText }}</router-link>
							</div>
							<img class="slide__image" :src="slide.image" alt="Slide image" />
						</div>
					</div>
				</template>
			</carousel>
...
::v-deep .owl-nav {
	...
	.owl-prev,
	.owl-next {
		// these are just to override the main styles of the buttons
		padding: 0 !important;
		margin: 0 !important;
